...
#
# git clone --recurse-submodules git@github.com:timlau/sfizz-ui.git 
# cd sfizz-ui/ 
# git ls-files --recurse-submodules | tar caf ~/rpmbuild/SOURCES/sfizz-1.2.3.tar.gz --xform s:^:sfizz-1.2.3/: --verbatim-files-from -T- 
#
